...
node{
  ...
  sh "$kubectl --insecure-skip-tls-verify=true --server=$kubeServer --username=$kubeUsername --password=$kubePassword rolling-update --image michaellee/dropwizard-guice-example:${localTag}"
