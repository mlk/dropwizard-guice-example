...
node{
  ...
  sh "$kubectl --namespace=default --insecure-skip-tls-verify=true --server=$kubeServer --username=$kubeUsername --password=$kubePassword rolling-update dropwizard-application --image 192.168.99.100:18443/michaellee/dropwizard-guice-example:${localTag}  --image-pull-policy=IfNotPresent"
